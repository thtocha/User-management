                ...
                <td>
                    <div class="d-flex justify-content-center">
                        <div class="btn-group text-center">
                            <button type="button" data-target="#updateUserModal" data-user-id="' . $user['id'] . '" data-user-name="' . $user['first_name'] . ' ' . $user['last_name'] . '" data-status="' . $user['status'] . '" data-user-role="' . $user['role'] . '" class="btn btn-outline-dark" style="font-size: 0.7rem" data-toggle="modal">
