...
<div class="container mt-3">
    <div class="row">
        <div class="col-md-12">
            ...
            <div id="userWarning" class="alert alert-danger mt-2" style="display: none;">Please select at least one user.</div>
            <div id="actionWarning" class="alert alert-danger mt-2" style="display: none;">Please select an action.</div>
